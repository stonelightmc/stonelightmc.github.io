...
function formatCoreLabel(server) {
  ...
  // В server-stats.json поле coreVersion может остаться старым после перехода ядра,
  // поэтому сначала берём версию Minecraft/Paper из serverVersion или bukkitVersion.
